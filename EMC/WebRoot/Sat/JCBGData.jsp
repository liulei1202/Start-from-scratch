  ...
  <head>
	...
	function ImportFile() {	
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param ="&type="+type+"&reportName="+reportName+ "&reportType="+reportType+ "&startTime="+startTime+ "&endTime="+endTime+ "&keyWords="+keyWords+ 
			"&bh=" + bh+"&station="+station + "&author=" + author +"&monitorLocation="+monitorLocation +"&equipment="+equipment+"&businessName="+businessName+"&businessType="+businessType;
			...
			var myUrl = "/rsui/DataImport/JCBGfileAutoImport_Sat.jsp?path=" + path + param;
		...
		<div id="middle">	
			...
			<div id="content">
			  ...
			  <h3>卫星监测-监测报告-数据导入</h3>
					...
					<!-- <td>中心频率</td><td><input type="text" id="startFrequence" placeholder="单位：MHz"></td> --><!-- 不确定是否有起始终止频率，暂时只输入中心频率，令终止频率等于中心频率 -->
					</tr><tr>
				  ...
				  <input type="hidden" id="type" value="WXJCBGData">
