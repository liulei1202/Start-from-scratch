  ...
  <head>
	...
	function ImportFile() {
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param = "&type=" + type + "&startTime=" + startTime +  "&endTime=" + endTime;
			param = param + "&frequence=" + frequence + "&station=" + station + "&monitor=" + monitor 
			...
			param = "DataImport/AudioFileAutoImport.jsp?fileName=" + fileName + param;
		...
		<div id="middle">	
			...
			<div id="content">
			  ...
			  <h3>短波-信号测向-音频数据</h3>
				  ...
				  <input type="hidden" id="type" value="DBXHCXAudioData">
