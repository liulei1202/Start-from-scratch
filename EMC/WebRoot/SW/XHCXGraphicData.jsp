  ...
  <head>
	...
	function ImportFile() {
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param = param + "&frequence=" + frequence + "&station=" + station 
			+ "&monitor=" + monitor + "&monitorLocation=" + monitorLocation
		...
		<div id="middle">	
			...
			<div id="content">
			  ...
			  <h3>短波-信号测向-图形数据</h3>
				  ...
				  <input type="hidden" id="type" value="DBXHCXGraphicData">
