	...
	<div id="all">
		...
		<div id="middle">	
			...
			<font>终止频率</font><input type="text" class="frequence" id="endFrequence" placeholder="单位：MHz"> 
			    ...
			    <input type="button"  onclick="downloadParameter('DBXHCXQuery')" value="批量导出" id="batchDownload"/>
			    </form>
				<div id="response">
				</div>
