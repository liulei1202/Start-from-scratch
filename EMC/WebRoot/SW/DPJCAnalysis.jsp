  ...
  <body>
	<div id="all">
		...
		<div id="middle">	
			...
			<font>起始频率</font><input type="text" class="frequence" id="startFrequence" placeholder="单位：MHz" style="width:100px;">
			<font>终止频率</font><input type="text" class="frequence" id="endFrequence" placeholder="单位：MHz" style="width:100px;"> 
