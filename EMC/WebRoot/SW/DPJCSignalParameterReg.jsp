		...
		<div id="middle">	
			<div id="menu">
				...
				<script>
			      ...
			      $("#DBDPJCSignalParameterReg").click();
            	</script>
			</div>
			<div id="content">
			  
			<h3 style="width:100%;">短波-单频监测-信号参数登记</h3>
			...
			<div style="width:100%;height:200px;position:relative;overflow:auto;">
			  ...
			  <input type="hidden" id="type" value="DBDPJCSignalParameterReg">
			</form>
			</div>
		  ...
		  <input type="hidden" id="uploadurl" value="<%=uploadUrl%>"/>
			...
			<script>
			  ...
			  $('#table1').find('tr').click(function() {
			    var idx = $(this).index();  // 索引是从0开始的，故+1
