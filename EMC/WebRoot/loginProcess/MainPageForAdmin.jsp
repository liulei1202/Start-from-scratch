		...
		<div id="middle">	
			...
			<div id="content">
				...
				<div style="clear:both;padding-left:40px;">
					<table class="userinfo" cellspacing="10px">
			 			<tr><th>用户名</th><th>用户类型</th><th>台站类型</th><th>真实姓名</th><th>单位名称</th><th>联系电话</th><th>审核状态</th><th>重置密码 </th><th>删除用户 </th><th>审核用户</th></tr>
			 			<% 
						...
						%>
						<tr>
			  	 		<td><%=userID %></td><td><%=userRole %></td><td><%=stationType %></td><td><%=realName %></td>
