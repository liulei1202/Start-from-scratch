...
String n= infile.importVideoData(path, fileType,businessType,businessName,signalType,longitude,latitude, startTime, endTime, frequence, startFrequence,  endFrequence, station, monitor, monitorLocation,bh);
