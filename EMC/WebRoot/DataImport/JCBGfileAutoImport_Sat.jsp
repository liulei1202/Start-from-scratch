...
String  n= infile.importJCBGData_Sat(path,fileType, reportName,reportType,startTime, endTime,keyWords, station, author, monitorLocation,equipment,businessType,businessName,bh);
