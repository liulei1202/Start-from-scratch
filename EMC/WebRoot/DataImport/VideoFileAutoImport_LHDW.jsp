...
String n= infile.importVideoData_LHDW(path, fileType,businessType,businessName,signalType,longitude,latitude, startTime, endTime, frequence, station, monitor, monitorLocation,bh);
