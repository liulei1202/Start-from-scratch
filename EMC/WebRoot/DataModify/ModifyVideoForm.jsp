  ...
  <head>
	...
	function ImportFile() {
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param = "DataImport/VideoFileAutoImport.jsp?fileName=" + fileName;
   	...
   	%>
	   	...
	   	<table>
  			<tr>
				  	...
				  	<td>终止频率(MHz)</td><td><input type="text" id="endFrequence" value="<%=emcdb.dynaRs.getDouble("endFrequence")/1000000 %>"></td>
					...
					<td></td><td></td><td></td><td><input type="button" value="提交" id="import" onclick="javascript:modifyVideoProcess('<%=bh%>','<%=type%>')"/></td>
			</tr>
		</table>
		</form>
   	<%}
