  ...
  <head>
	...
	function ImportFile() {
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param = "DataImport/VideoFileAutoImport_LHDW.jsp?fileName=" + fileName;
   	...
   	%>
	   	...
	   	<table>
  			<tr>
					...
					<td></td><td><input type="button" value="提交" id="import" onclick="javascript:modifyVideoProcess_LHDW('<%=bh%>','<%=type%>')"/></td>
			</tr>
		</table>
		</form>
   	<%}
