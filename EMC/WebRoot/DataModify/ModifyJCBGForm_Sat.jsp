...
<html>
  <head>
	...
	function ImportFile() {
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param ="&type="+type+ "&reportName="+reportName+ "&reportType="+reportType
		    ...
		    param = "DataImport/JCBGfileAutoImport_Sat.jsp?path=" + path + param;
  ...
  <body onload="setupUpload();" style="padding:30px 0 0 15px;">
    ...
    String table = null;
    if(type.trim().equals("WXJCBGQuery")){
	   	...
	   	<table>
  			...
  			<tr>
				...
				<datalist id="cars">
			  	...
			  	<td></td><td><input type="button" value="提交" id="import" onclick="javascript:modifyJCBGProcess_Sat('<%=bh%>','<%=type%>')"/></td>
			</tr>
		</table>
		</form>
   	<%}
