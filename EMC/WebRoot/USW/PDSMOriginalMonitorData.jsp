			...
			<div id="menu">
				...
				<%} %>
				  <script>
			       ...
			       $("#CDBPDSMOriginalMonitorData").click();
            	  </script>
			</div>
			<div id="content">
			  
			  <h3>超短波-频段扫描-原始监测数据</h3>
				  <table id="info">
				  	<tr>
					...
					<td>操作人</td><td><input type="text" id="monitor" placeholder="" list="cars"/>
					<datalist id="cars">
						<% 
				  ...
				  <input type="hidden" id="type" value="CDBPDSMOriginalMonitorData">
