	...
	<div id="all">
		...
		<div id="middle">	
			...
			<font>监测地点</font><select id="monitorlocation">
			    ...
			    <input type="button"  onclick="downloadParameter('CDBDPJCQuery')" value="批量导出" id="batchDownload"/>
			</form>
			<div id="response">
			</div>
