  ...
  <body>
	<div id="all">
		...
		<div id="middle">	
			...
			<font>起始频率</font><input type="text" class="frequence" id="startFrequence">
			<font>终止频率</font><input type="text" class="frequence" id="endFrequence"> 
				...
				监测地点<select id="monitorlocation">
					<option value="" >
				<%
			    ...
			    <input type="button"  onclick="downloadParameter('CDBXHCXQuery')" value="批量导出" id="batchDownload"/>
