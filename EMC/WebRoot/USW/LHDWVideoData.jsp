  ...
  <head>
	...
	function ImportFile() {
		...
		for ( var i = 0; i < rowsLength; i++) {
			...
			param = "DataImport/VideoFileAutoImport_LHDW.jsp?fileName=" + fileName + param;
			...
			<div id="menu">
				...
				<%} %>
				 <script>
			      $("#CDB").click();
			      $("#CDBLHDW").click(); 	
			      $("#CDBLHDWDataimport").click();
			      $("#CDBLHDWVideoData").click();
            	 </script>
			</div>
			<div id="content">
			  ...
			  <h3>超短波-联合定位-视频数据</h3>
				  ...
				  <input type="hidden" id="type" value="CDBLHDWVideoData">
