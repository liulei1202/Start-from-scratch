		...
		<div id="middle">	
			<div id="menu">
				...
				<%} %>
				 <script>
			      ...
			      $("#CDBXHCXSignalParameterReg").click();
            	 </script>
			</div>
			<div id="content">
			  
			<h3 style="width:100%;">超短波-信号测向-信号参数登记</h3>
			...
			<div style="width:100%;height:200px;position:relative;overflow:auto;">
			  ...
			  <table id="info" border="0" cellpadding="0" cellspacing="0" style="background-color:#ffffff;width:100%;position:absolute;overflow:auto;">                
	            ...
	            <td><input type="hidden" id="bh" value="XHCX-20171016_9:58-9.56---顺义站--43.1-2017-11-04 15:00:17 "></td>   
	            </tr>
			  </table>
			  <table id="table1"></table>
			  <input type="hidden" id="type" value="CDBXHCXSignalParameterReg">
			</form>
			</div>
