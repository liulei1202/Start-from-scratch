	...
	<div id="all">
		...
		<div id="middle">	
			<div id="menu">
				...
				<%} %>
				 <script>
			      ...
			      $("#CDBDPJCSignalParameterReg").click();
            	 </script>
			</div>
			<div id="content">
			  
			<h3 style="width:100%;">超短波-单频监测-信号参数登记</h3>
			...
			<div style="width:100%;height:200px;position:relative;overflow:auto;">
			  ...
			  <input type="hidden" id="type" value="CDBDPJCSignalParameterReg">
			</form>
			</div>
